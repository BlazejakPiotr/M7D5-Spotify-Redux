  ...
  return (
    <>
      ...
      <Row className="text-white">
        <Col className="d-flex justify-content-center">Title/Artist</Col>
        <Col className="d-flex justify-content-center">Album</Col>
        <Col className="d-flex justify-content-center">Duration</Col>
      </Row>
